...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: ':recipeId',
                loadChildren: () => __webpack_require__.e(/*! import() | recipes-recipe-detail-recipe-detail-module */ "common").then(__webpack_require__.bind(null, /*! ./recipes/recipe-detail/recipe-detail.module */ "./src/app/recipes/recipe-detail/recipe-detail.module.ts")).then(m => m.RecipeDetailPageModule)
            }
        ]
    }
];
...
module.exports = __webpack_require__(/*! /home/shazaib/ionic-app/src/main.ts */"./src/main.ts");
